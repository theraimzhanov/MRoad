package com.motion.muslimcollection.ui.mosque.mosque_library.maps
...
class LibraryMapsFragment : BaseFragment(R.layout.fragment_library_maps),OnMapReadyCallback {
    private val viewModel: LibraryViewModel by inject()
    val args: LibraryMapsFragmentArgs by navArgs()
    ...
    override fun setupObservers() {
        val mapFragment = childFragmentManager.findFragmentById(R.id.map_lb) as SupportMapFragment?
        mapFragment?.getMapAsync(this)
    }

    override fun showConnectedState() {
        initData(args.lbMaps)
    }
    private fun initData(id:Int) {
        viewModel.getLibraryItem(id)
    }
}
